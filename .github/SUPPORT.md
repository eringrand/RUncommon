# Getting help with RUncommon

Thanks for using RUncommon. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/RUncommon/issues) to make sure the 
